...
coefplot(list(
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        ...
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0204_spouse_p, Female == 1 & urban == 2 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh)
...
coefplot(list(
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0204_spouse_p, age > 17 & age < 31 & year == 2002 & married == 2 | year == 2004 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0204_spouse_p, age > 30 & year == 2002 & married == 2 | year == 2004 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh)
), main = "", zero.par = list( type="dotted", lty=2))
legend("bottomleft", col = 1:2, pch = 1, lwd = 2, cex = 1, bty = "n", 
...
coefplot(list(
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0206_spouse_p, age > 17 & age < 31 & year == 2002 & married == 2 | year == 2006 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0206_spouse_p, age > 30 & year == 2002 & married == 2 | year == 2006 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh)
), main = "", zero.par = list( type="dotted", lty=2))
legend("bottomleft", col = 1:2, pch = 1, lwd = 2, cex = 1, bty = "n", 
