...
etable(list(
  feols(inc_ratio ~ provtariff | hhid02 + year,
        subset(inc_0204_spouse_p, Female == 1 & educ < 10 & educ > 5 & year == 2002 & married == 2 | year == 2004 & Female == 1 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff_k | hhid02 + year,
        subset(inc_0204_spouse_p, Female == 1 & educ < 10 & educ > 5 & year == 2002 & married == 2 | year == 2004 & Female == 1 & married == 2),
        ...
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff| hhid06 + year,
        subset(inc_0206_spouse_p, Female == 1 & educ < 10 & educ > 5 & year == 2002 & married == 2 | year == 2006 & Female == 1 & married == 2),
        weights = ~hhwt, 
        vcov = ~tinh),
  feols(inc_ratio ~ provtariff_k | hhid06 + year,
        subset(inc_0206_spouse_p, Female == 1 & educ < 10 & educ > 5 & year == 2002 & married == 2 | year == 2006 & Female == 1 & married == 2),
